<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Position_ChoseAlarmData.aspx.cs" Inherits="WebSite.Position_ChoseAlarmData" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Add" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAlltest" TypeName="BLL.alarm_management_DAL" UpdateMethod="Delete">
                    <DeleteParameters>
